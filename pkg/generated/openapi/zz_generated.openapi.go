...
func GetOpenAPIDefinitions(ref openapi.ReferenceCallback) map[string]openapi.OpenAPIDefinition {
	return map[string]openapi.OpenAPIDefinition{
		...
		"k8s.io/kubernetes/pkg/api/v1.FDSVolumeSource": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Properties: map[string]spec.Schema{
						"aksk": {
					...
					Required: []string{"aksk", "bucketName", "endpoint"},
				},
			},
			Dependencies: []string{},
		},
			...
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					...
					Properties: map[string]spec.Schema{
						...
						"fdsVolume": {
							SchemaProps: spec.SchemaProps{
								Ref: ref("k8s.io/kubernetes/pkg/api/v1.FDSVolumeSource"),
							},
						},
					},
					Required: []string{"name"},
